        ...
        <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-lg">
            ...
            <form class="space-y-4 md:space-y-6" method="POST" action="/login">
                ...
                <div class="mb-6">
                    ...
                    bg-white border-2 border-gray-300 placeholder-gray-600 shadow-sm
                ...
                <div class="py-2" x-data="{ show: true }">
                    ...
                    <div class="relative">
                        <input placeholder="" :type="show ? 'password' : 'text'" type="password" id="password" name="password" class="text-md block px-3 py-2 rounded-lg w-full 
                        bg-white border-2 border-gray-300 placeholder-gray-600 shadow-sm
                        focus:placeholder-gray-500
                        focus:bg-white 
                        focus:border-gray-600  
