...
<form id="form_parameter" action="{{ route('parameter.create') }}" method="POST">
    ...
    <div class="flex flex-col w-full h-full justify-center items-center pointer-events-none fixed">
        <div id="konten_modal"
            class="flex scale-0 flex-col duration-500 ease-in-out w-[90%] lg:w-[1000px] max-h-[90%] bg-white rounded-lg pointer-events-auto drop-shadow-lg overflow-hidden dark:bg-slate-700 dark:text-white">
            <header>
                <div
            ...
            <div class="flex flex-col flex-grow w-full px-6 lg:px-12 mt-4 overflow-y-auto">
                <div class="grid grid-cols-1 h-full gap-4">
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex md:flex-row gap-2 w-full flex-col">
                            ...
                            <div class="relative pt-4 flex-1">
                                ...
                                <p class="absolute top-2 px-2 bg-white dark:bg-slate-700 left-6 text-xs">Batas Atas</p>
                                <p
                                    class="absolute right-4 top-2 h-full text-xs text-center items-center flex justify-center">
                                    m2</p>
                            </div>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex md:flex-row gap-2 w-full flex-col">
                            <div class="relative pt-4 flex-1 ">
                                <input key="batas bawah curah hujan" oninput="validateNumberInput(this)"
                                    maxlength="13" class="w-full border-[2px] px-3 py-2 rounded-lg outline-primary"
                                    type="text" name="hujan_bawah" id="hujan_bawah" placeholder="">
                                <p class="absolute top-2 px-2 bg-white dark:bg-slate-700 left-6 text-xs">Batas Bawah
                                </p>
                            </div>
                            <div class="relative pt-4 flex-1">
                                <input key="batas atas curah hujan" oninput="validateNumberInput(this)"
                                    maxlength="13" class="w-full border-[2px] px-3 py-2 rounded-lg outline-primary"
                                    type="text" name="hujan_atas" id="hujan_atas" placeholder="">
                                <p class="absolute top-2 px-2 bg-white dark:bg-slate-700 left-6 text-xs">Batas Atas</p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex md:flex-row gap-2 w-full flex-col">
                            <div class="relative pt-4 flex-1 ">
                                <input key="batas bawah ketinggian" oninput="validateNumberInput(this)"
                                    maxlength="13" class="w-full border-[2px] px-3 py-2 rounded-lg outline-primary"
                                    type="text" name="ketinggian_bawah" id="ketinggian_bawah" placeholder="">
                                <p class="absolute top-2 px-2 bg-white dark:bg-slate-700 left-6 text-xs">Batas Bawah
                                </p>
                                <p
                                    class="absolute right-4 top-2 h-full text-xs text-center items-center flex justify-center">
