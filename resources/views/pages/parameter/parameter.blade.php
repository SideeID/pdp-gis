...
@section('otherjs')
    ...
    <script src="{{ asset('js/parameterController.js') }}"></script>
@endsection

@section('modal')
    @include('pages.parameter.create')
@endsection
            ...
            <li>
                <div class="flex items-center"><svg class="w-3 h-3 text-gray-400 mx-1" aria-hidden="true"
                        ...
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 9 4-4-4-4"></path>
                    </svg><a href="{{ route('parameter') }}"
                        class="ml-1 text-sm font-medium text-gray-700 hover:text-primary md:ml-2 dark:text-gray-400 dark:hover:text-white">Parameter</a>
                </div>
            </li>
        </ol>
    </nav>
