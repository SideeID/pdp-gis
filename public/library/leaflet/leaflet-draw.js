    ...
    (L.drawVersion = "0.4.2"),
        ...
        (L.Draw.Polyline = L.Draw.Feature.extend({
            ...
            _finishShape: function () {
                ...
                return (!this.options.allowIntersection && e) ||
                    !this._shapeIsValid()
                    ? void this._showErrorTooltip()
                    : (this._fireCreatedEvent(),
                      this.disable(),
            ...
            _onMouseUp: function (e) {
                if (this._mouseDownOrigin) {
                    ...
                    Math.abs(i) < 9 * (t.devicePixelRatio || 1) &&
            ...
            _updateFinishHandler: function () {
                ...
                t > 1 &&
                    this._markers[t - 1].on("click", this._finishShape, this),
                    t > 2 &&
            ...
            _updateGuide: function (t) {
                ...
                e > 0 &&
                    ((t =
                        t || this._map.latLngToLayerPoint(this._currentLatLng)),
                    this._clearGuides(),
                    this._drawGuide(
                        this._map.latLngToLayerPoint(
                            this._markers[e - 1].getLatLng()
                        ),
                        t
                    ));
            },
            ...
            _updateGuideColor: function (t) {
                if (this._guidesContainer)
                    for (
                        ...
                        this._guidesContainer.childNodes[
                            e
            ...
            _getTooltipText: function () {
                ...
                return (
                    0 === this._markers.length
                        ? (t = {
                              text: L.drawLocal.draw.handlers.polyline.tooltip
                                  .start,
                          })
                        : ((e = i ? this._getMeasurementString() : ""),
                          (t =
                              1 === this._markers.length
                                  ? {
                                        text: L.drawLocal.draw.handlers.polyline
                                            .tooltip.cont,
                                        subtext: e,
                                    }
                                  : {
        ...
        (L.Draw.Polygon = L.Draw.Polyline.extend({
            ...
            _getMeasurementString: function () {
                var t = this._area;
                return t
                    ? L.GeometryUtil.readableArea(t, this.options.metric)
                    : null;
            },
            _shapeIsValid: function () {
        ...
        (L.Draw.Marker = L.Draw.Feature.extend({
            ...
            addHooks: function () {
                L.Draw.Feature.prototype.addHooks.call(this),
                    this._map &&
                        (this._tooltip.updateContent({
                            text: L.drawLocal.draw.handlers.marker.tooltip
                                .start,
                        }),
                        this._mouseMarker ||
                            (this._mouseMarker = L.marker(
        ...
        (L.Edit.PolyVerticesEdit = L.Handler.extend({
            ...
            _initMarkers: function () {
                ...
                for (t = 0, e = i - 1; t < i; e = t++)
                    (0 !== t ||
                        ...
                        ((s = this._markers[e]),
                        (a = this._markers[t]),
                        this._createMiddleMarker(s, a),
                        this._updatePrevNext(s, a));
            },
            ...
            _spliceLatLngs: function () {
                ...
                return (
                    this._poly._convertLatLngs(t, !0), this._poly.redraw(), e
                );
            },
            ...
            _onMarkerDrag: function (t) {
                ...
                if (
                    ...
                    e._middleLeft &&
                        e._middleLeft.setLatLng(
                            this._getMiddleLatLng(e._prev, e)
                        ),
                    e._middleRight &&
                        e._middleRight.setLatLng(
                            this._getMiddleLatLng(e, e._next)
                        ),
                    i.options.poly)
                ) {
                        ...
                        i.setStyle({ color: this.options.drawError.color }),
                            ...
                            setTimeout(function () {
                                i.setStyle({ color: n }),
                                    o &&
                                        o.updateContent({
                                            text: L.drawLocal.edit.handlers.edit
                                                .tooltip.text,
                                            subtext:
            ...
            _onMarkerClick: function (t) {
                ...
                this._defaultShape().length < e ||
                    ...
                    i._middleLeft &&
                        this._markerGroup.removeLayer(i._middleLeft),
                    i._middleRight &&
            ...
            _onTouchMove: function (t) {
                var e = this._map.mouseEventToLayerPoint(
                ...
                L.extend(o._origLatLng, i),
                    o._middleLeft &&
                        o._middleLeft.setLatLng(
                            this._getMiddleLatLng(o._prev, o)
                        ),
                    o._middleRight &&
                        o._middleRight.setLatLng(
                            this._getMiddleLatLng(o, o._next)
                        ),
                    this._poly.redraw(),
                    this.updateMarkers();
            },
        ...
        (L.Edit.SimpleShape = L.Handler.extend({
            ...
            _onTouchStart: function (t) {
                if (
                    (L.Edit.SimpleShape.prototype._onMarkerDragStart.call(
                        this,
                        t
                    ),
            ...
            _onTouchMove: function (t) {
                var e = this._map.mouseEventToLayerPoint(
                    ...
                    o = t.target;
                return (
                    o === this._moveMarker ? this._move(i) : this._resize(i),
                    this._shape.redraw(),
                    !1
                );
            },
                ...
                if (e)
                    o =
                        t > 1e3
                            ? (t / 1e3).toFixed(2) + " km"
                            : Math.ceil(t) + " m";
                else if (((t *= 1.09361), t > 1760))
                    o = (t / 1760).toFixed(2) + " miles";
                else {
                    var n = " yd";
        ...
        L.Polyline.include({
            ...
            newPointIntersects: function (t, e) {
                ...
                return (
                    ...
                    this._lineSegmentsIntersectsRange(n, t, s, e ? 1 : 0)
                );
            },
            ...
            _getProjectedPoints: function () {
                ...
                for (
                    var t = [], e = this._defaultShape(), i = 0;
                    i < e.length;
                    i++
                )
            ...
            intersects: function () {
                ...
                return (
                    ...
                    (!!(t = L.Polyline.prototype.intersects.call(this)) ||
                        ...
                        (o = s[e - 1]),
                        (n = e - 2),
                        this._lineSegmentsIntersectsRange(o, i, n, 1)))
                );
            },
        }),
        (L.Control.Draw = L.Control.extend({
            ...
            onAdd: function (t) {
                ...
                for (var s in this._toolbars)
                    this._toolbars.hasOwnProperty(s) &&
                        ...
                        e &&
                            (o ||
                                (L.DomUtil.hasClass(e, n) ||
                                    L.DomUtil.addClass(e.childNodes[0], n),
                                (o = !0)),
                            i.appendChild(e)));
                return i;
            },
            onRemove: function () {
                for (var t in this._toolbars)
                    this._toolbars.hasOwnProperty(t) &&
                        this._toolbars[t].removeToolbar();
            },
        ...
        (L.EditToolbar = L.Toolbar.extend({
            ...
            initialize: function (t) {
                t.edit &&
                    ...
                    t.poly &&
                        (t.poly = L.extend({}, this.options.poly, t.poly)),
            ...
            _backupLayer: function (t) {
                ...
                this._uneditedLayerProps[e] ||
                    ...
                    t instanceof L.Rectangle
                        ? (this._uneditedLayerProps[e] = {
                              latlngs: L.LatLngUtil.cloneLatLngs(
                                  t.getLatLngs()
                              ),
                          })
